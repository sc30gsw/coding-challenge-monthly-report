...
| 確定           | ✅        | ❌                   | ❌             | `in_review`           |
| 修正版の作成   | ✅        | ❌                   | ❌             | `confirmed`           |
| 閲覧           | 全 Report | 関係する Report 全体 | ❌             | 全状態                |

「関係する Report」= 自分が担当する ReportLine を 1 件以上含む Report。営業は Report を**全体として**閲覧できる（金額合計や他の明細が見えないと承認の意味が痩せるため）が、操作できるのは自分の担当明細だけ。
